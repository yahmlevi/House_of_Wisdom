...
contract('Integrate Curve.Fi into your defi', async([ owner, defiowner, user1, user2 ]) => {
    ...
    before( async() => {
        ...
        console.log("defiowner address = " + defiowner);
        ...
        // await curveLPToken.methods['initialize(string,string,uint256)']('Curve.fi yDAI/yUSDC/yUSDT/yTUSD', 'yDAI+yUSDC+yUSDT+yTUSD', 18, {from:owner});
        await curveLPToken.initialize('Curve.fi yDAI/yUSDC/yUSDT/yTUSD', 'yDAI+yUSDC+yUSDT+yTUSD', 18, {from:owner});
    ...
    describe('Deposit your money into Curve.Fi', () => {
        it('Deposit', async() => {
            // moneyToCurve is the spender - from user1
            ...
            console.log("user1's balance of dai before = " + daiBefore);
            console.log("user1's balance of usdc before = " + usdcBefore);
            console.log("user1's balance of tusd before = " + tusdBefore);
            console.log("user1's balance of usdt before = " + usdtBefore);

            console.log("moneyToCurve.multiStepDeposit - from user1");
            ...
            console.log("user1's balance of dai after = " + daiAfter);
            console.log("user1's balance of usdc after = " + usdcAfter);
            console.log("user1's balance of tusd after = " + tusdAfter);
            console.log("user1's balance of usdt after = " + usdtAfter);
        ...
        it('CRV tokens are minted and transfered to the user', async() => {
            ...
            const balanceOfUser1 = (await crvToken.balanceOf(user1)).toNumber();
    ...
    describe('Withdraw your money from Curve.Fi', () => {
        it('Withdraw', async() => {
            ...
            // user1 withdraws money from Curve.Fi (same deposited amounts)
